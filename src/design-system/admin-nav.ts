...
export const ADMIN_NAV: AdminNavItem[] = [
  ...
  { id: "templates", label: "Template Studio", href: "/app/admin/templates", icon: Palette, group: "control", configOnly: true },
  ...
  { id: "ipd-rounds", label: "IPD rounds", href: "/app/admin/ipd-rounds", icon: ClipboardList, group: "control", configOnly: true },
  { id: "pharmacy", label: "Pharmacy inventory", href: "/app/admin/pharmacy", icon: Pill, group: "control" },
