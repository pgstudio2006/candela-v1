...
export const DEFAULT_DOCUMENT_TEMPLATES: DocumentTemplate[] = [
  ...
  },
  {
    ...
    marginRight: 20,
    overlayFields: [
      { id: "rp_ward", key: "ward", label: "Ward", x: 10, y: 62, width: 80, height: 6, fontSize: 15, fontStyle: "bold", align: "center" },
      { id: "rp_bed", key: "bed", label: "Bed", x: 10, y: 71, width: 80, height: 8, fontSize: 22, fontStyle: "bold", align: "center" },
      { id: "rp_patient", key: "patientName", label: "Patient", x: 10, y: 82, width: 80, height: 6, fontSize: 13, fontStyle: "bold", align: "center" },
      { id: "rp_uhid", key: "uhid", label: "UHID", x: 10, y: 91, width: 80, height: 4, fontSize: 9, align: "center" },
    ],
    enabled: true,
    isSystem: true,
  },
