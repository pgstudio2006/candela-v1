...
export const DEFAULT_DOCUMENT_TEMPLATES: DocumentTemplate[] = [
  ...
  },
  {
    ...
    marginRight: 20,
    overlayFields: [
      { id: "rp_ward", key: "ward", label: "Ward", x: 10, y: 43, width: 80, height: 8, fontSize: 16, fontStyle: "bold", align: "center" },
      { id: "rp_bed", key: "bed", label: "Bed", x: 10, y: 58, width: 80, height: 10, fontSize: 22, fontStyle: "bold", align: "center" },
      { id: "rp_patient", key: "patientName", label: "Patient", x: 10, y: 76, width: 80, height: 7, fontSize: 13, fontStyle: "bold", align: "center" },
      { id: "rp_uhid", key: "uhid", label: "UHID", x: 10, y: 87, width: 80, height: 5, fontSize: 9, align: "center" },
    ],
    enabled: true,
    isSystem: true,
  },
